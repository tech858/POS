...
class PlanList extends Component
{
    ...
    public function mount()
    {
        ...
        $this->selectedCurrency = $this->currencies->first()->id ?? null;
    ...
    private function handleOfflinePayments()
    {
        if ($this->offlinePaymentGateways == 1) {
            $this->offlineMethodId = $this->methods->first()?->id;
            $this->show = 'authorize';
        }
    ...
    public function offlinePaymentSubmit()
    {
        ...
        $offlinePlanChange->package_type = $this->isAnnual ? 'annual' : 'monthly';

                ...
                @if ($razorpayStatus)
                    ...
                    @else
                        ...
                        <div>
                            ...
                            <x-input id="testRazorpaySecret" class="block mt-1 w-full" type="text" wire:model='testRazorpaySecret'/>
                ...
                @if ($stripeStatus)
                    ...
                    @else
                        ...
                        <div>
                            ...
                            <x-input id="testStripeSecret" class="block mt-1 w-full" type="text" wire:model='testStripeSecret'/>

    ...
    <x-slot name="title">
        ...
        <div class="flex justify-between items-center">
            ...
            <div class="flex items-center gap-4">
                ...
                <span class="text-xl font-bold text-skin-base">{{ currency() }}{{ number_format($order->total, 2) }}</span>
            </div>
        </div>
        @endif
    </x-slot>
                        ...
                        <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                            <div class="space-y-2">
                                <div class="flex justify-between">
                                    ...
                                    <span class="font-medium">{{ currency() }}{{ number_format($order->total, 2) }}</span>
                                </div>
                                <div class="flex justify-between">
                                    <span>{{ __('modules.order.amountPaid') }}</span>
                                    <span class="font-medium">{{ currency() }}{{ number_format($paidAmount, 2) }}</span>
                                </div>
                                @if($paymentMethod === 'cash')
                                    @if($returnAmount > 0)
                                    <div class="flex justify-between text-green-600 pt-2 border-t">
                                        <span>{{ __('modules.order.returnAmount') }}</span>
                                        <span class="font-medium">{{ currency() }}{{ number_format($returnAmount, 2) }}</span>
                                    </div>
                                    @else
                                    <div class="flex justify-between text-red-600 pt-2 border-t">
                                        <span>{{ __('modules.order.dueAmount') }}</span>
                                        <span class="font-medium">{{ currency() }}{{ number_format($balanceAmount, 2) }}</span>
                                    </div>
                                    @endif
                                @else
                                            ...
                                            <div class="flex justify-between items-center">
                                                ...
                                                <div class="text-right">
                                                    ...
                                                    <div class="text-xs text-gray-500">
                                                        <span>{{ __('modules.order.base') }}: {{ currency() }}{{ number_format($item['base_price'], 2) }}</span>
                                                        @if($item['tax_amount'] > 0)
                                                            <span>+ {{ __('modules.order.tax') }}: {{ currency() }}{{ number_format($item['tax_amount'], 2) }}</span>
                                                        @endif
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="flex justify-between items-center">
                                                ...
                                                <div class="flex items-center gap-4">
                                                    <div class="text-right">
                                                        ...
                                                        <div class="text-xs text-gray-500">
                                                            <span>{{ __('modules.order.base') }}: {{ currency() }}{{ number_format($item['base_price'] * $item['quantity'], 2) }}</span>
                                                            @if($item['tax_amount'] > 0)
                                                                <span>+ {{ __('modules.order.tax') }}: {{ currency() }}{{ number_format($item['tax_amount'] * $item['quantity'], 2) }}</span>
                                                            @endif
                                                        </div>
                                                    </div>
                    ...
                    <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                        <div class="space-y-2">
                            ...
                            <div class="flex justify-between">
                                ...
                                <span class="font-medium">{{ currency() }}{{ number_format(collect($splits)->sum('total'), 2) }}</span>
                            </div>
                        </div>
                    </div>
                </div>

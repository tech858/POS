  ...
  <div class="px-3 py-3 lg:px-5 lg:pl-3">
    <div class="flex items-center justify-between">
      ...
      <div class="flex items-center justify-start">
        ...
        <a href="{{ route('dashboard') }}" class="flex ltr:ml-2 rtl:mr-2 ltr:md:mr-24 rtl:md:ml-24 items-center">
          <img src="{{ restaurant()->logoUrl }}" class="h-8 ltr:mr-3 rtl:ml-3" alt="App Logo" />

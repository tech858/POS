<div class="lg:w-5/12 flex flex-col bg-white border-l dark:border-gray-700 min-h-[800px] pr-4 px-2 py-4 dark:bg-gray-800">
    <div class="flex-grow">
        ...
        <div class="flex justify-between mb-2 items-center gap-2">
            <div class="py-2 inline-flex items-center gap-1 text-sm">
